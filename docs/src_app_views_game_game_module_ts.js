...
let InventoryComponent = /*#__PURE__*/(() => {
  class InventoryComponent {
    ...
    static ɵcmp = /*@__PURE__*/_angular_core__WEBPACK_IMPORTED_MODULE_5__["ɵɵdefineComponent"]({
      ...
      decls: 6,
      vars: 2,
      consts: [[1, "inventory"], ["class", "empty-note", 4, "ngIf"], [1, "item-list"], ["class", "item-card", 4, "ngFor", "ngForOf"], [1, "empty-note"], [1, "item-card"], [1, "item-icon", 3, "src", "alt"], [1, "item-details"], [1, "item-header"], [1, "item-name"], [1, "item-type"], [1, "item-description"], ["class", "item-bonuses", 4, "ngIf"], [1, "item-actions"], ["class", "rpg-button small buff-button", "title", "Tempor\u00E4rer Effekt \u2013 h\u00E4lt 5 Minuten", 3, "click", 4, "ngIf"], ["class", "rpg-button small consumable-button", "title", "Einmaliger Soforteffekt", 3, "click", 4, "ngIf"], ["class", "rpg-button small equipment-button", 3, "title", "click", 4, "ngIf"], [1, "item-bonuses"], [4, "ngIf"], ["title", "Tempor\u00E4rer Effekt \u2013 h\u00E4lt 5 Minuten", 1, "rpg-button", "small", "buff-button", 3, "click"], ["title", "Einmaliger Soforteffekt", 1, "rpg-button", "small", "consumable-button", 3, "click"], [1, "rpg-button", "small", "equipment-button", 3, "click", "title"]],
